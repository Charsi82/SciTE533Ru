...
function PathCollapse(s)
	return (s:gsub(props['SciteDefaultHome'], "$SciteDefaultHome", 1))
end

function PathExpand(s)
	return (s:gsub("$SciteDefaultHome", props['SciteDefaultHome'], 1))
end
